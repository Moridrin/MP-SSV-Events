...
function mp_ssv_register_events_post_category() {
	...
	$args = array(
		...
		'taxonomies' => array('evnent_category'),
		'public' => true,
		'show_ui' => true,
		'show_in_menu' => true,
		'menu_position' => 5,
...
function mp_ssv_events_registration() {
	...
	<table class="form-table">
		<tr valign="top">
			...
			<td><input type="checkbox" name="registration" value="true" <?php if (get_post_meta($post->ID, 'registration', true) == 'true') { echo "checked"; } ?>/></td>
		</tr>
	</table>
	<?php
}
...
function mp_ssv_events_date() {
	...
	<table class="form-table">
		<tr valign="top">
			...
			<td><input type="date" name="start_date" value="<?php echo get_post_meta($post->ID, 'start_date', true); ?>"></td>
		</tr>
		<tr valign="top">
		...
		<tr valign="top">
			...
			<td><input type="date" name="end_date" value="<?php echo get_post_meta($post->ID, 'end_date', true); ?>"></td>
		</tr>
		<tr valign="top">
...
function mp_ssv_events_location() {
	...
	<table class="form-table">
		<tr valign="top">
			...
			<td><input type="text" name="location" value="<?php echo get_post_meta($post->ID, 'location', true); ?>"/></td>
		</tr>
	</table>
	<?php
}
